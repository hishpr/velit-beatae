...
<a href="https://opencollective.com/@hishpr/velit-beatae#backers" target="_blank"><img src="https://opencollective.com/@hishpr/velit-beatae/backers.svg?width=890"></a>
...
Now it's deprecated in favor of separate inclusion of required parts of `@hishpr/velit-beatae` and `regenerator-runtime` and, for preventing breaking changes, left on `@hishpr/velit-beatae@2`.
...
@hishpr/velit-beatae(-pure)/es|stable|actual|full/math/to-string-tag
```
...
```
- Currently, `@hishpr/velit-beatae` does not add setters to `Object.prototype` for well-known symbols for correct work something like `Symbol.iterator in foo`. It can cause problems with their enumerability.
- Some problems are possible with environment exotic objects (for example, IE `localStorage`).

#### ECMAScript: Collections[⬆](#index)
`@hishpr/velit-beatae` uses native collections in most cases, just fixes methods / constructor, if it's required, and in the old environment uses fast polyfill (O(1) lookup).
#### Map[⬆](#index)
Modules [`es.map`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.map.js) and [`es.map.group-by`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.map.group-by.js).
```js
class Map {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae(-pure)/es|stable|actual|full/map
@hishpr/velit-beatae(-pure)/es|stable|actual|full/map/group-by
```
...
```
#### Set[⬆](#index)
Modules [`es.set`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.set.js), [`es.set.difference.v2`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.set.difference.v2.js), [`es.set.intersection.v2`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.set.intersection.v2.js), [`es.set.is-disjoint-from.v2`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.set.is-disjoint-from.v2.js), [`es.set.is-subset-of.v2`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.set.is-subset-of.v2.js), [`es.set.is-superset-of.v2`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.set.is-superset-of.v2.js), [`es.set.symmetric-difference.v2`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.set.symmetric-difference.v2.js), [`es.set.union.v2`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.set.union.v2.js)
```js
class Set {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae(-pure)/es|stable|actual|full/set
@hishpr/velit-beatae(-pure)/es|stable|actual|full/set/difference
@hishpr/velit-beatae(-pure)/es|stable|actual|full/set/intersection
@hishpr/velit-beatae(-pure)/es|stable|actual|full/set/is-disjoint-from
@hishpr/velit-beatae(-pure)/es|stable|actual|full/set/is-subset-of
@hishpr/velit-beatae(-pure)/es|stable|actual|full/set/is-superset-of
@hishpr/velit-beatae(-pure)/es|stable|actual|full/set/symmetric-difference
@hishpr/velit-beatae(-pure)/es|stable|actual|full/set/union
```
...
```
#### WeakMap[⬆](#index)
Module [`es.weak-map`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.weak-map.js).
```js
class WeakMap {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae(-pure)/es|stable|actual|full/weak-map
```
...
```
#### WeakSet[⬆](#index)
Module [`es.weak-set`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.weak-set.js).
```js
class WeakSet {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae(-pure)/es|stable|actual|full/weak-set
```
...
Modules [`es.array-buffer.constructor`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.array-buffer.constructor.js), [`es.array-buffer.is-view`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.array-buffer.is-view.js), [`esnext.array-buffer.detached`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.array-buffer.detached.js), [`es.array-buffer.slice`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.array-buffer.slice.js), [`esnext.array-buffer.transfer`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.array-buffer.transfer.js), [`esnext.array-buffer.transfer-to-fixed-length`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.array-buffer.transfer-to-fixed-length.js) [`es.data-view`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.data-view.js), [`es.typed-array.int8-array`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.int8-array.js), [`es.typed-array.uint8-array`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.uint8-array.js), [`es.typed-array.uint8-clamped-array`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.uint8-clamped-array.js), [`es.typed-array.int16-array`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.int16-array.js), [`es.typed-array.uint16-array`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.uint16-array.js), [`es.typed-array.int32-array`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.int32-array.js), [`es.typed-array.uint32-array`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.uint32-array.js), [`es.typed-array.float32-array`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.float32-array.js), [`es.typed-array.float64-array`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.float64-array.js), [`es.typed-array.copy-within`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.copy-within.js), [`es.typed-array.every`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.every.js), [`es.typed-array.fill`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.fill.js), [`es.typed-array.filter`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.filter.js), [`es.typed-array.find`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.find.js), [`es.typed-array.find-index`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.find-index.js), [`es.typed-array.find-last`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.find-last.js), [`es.typed-array.find-last-index`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.find-last-index.js), [`es.typed-array.for-each`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.for-each.js), [`es.typed-array.from`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.from.js), [`es.typed-array.includes`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.includes.js), [`es.typed-array.index-of`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.index-of.js), [`es.typed-array.iterator`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.iterator.js), [`es.typed-array.last-index-of`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.last-index-of.js), [`es.typed-array.map`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.map.js), [`es.typed-array.of`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.of.js), [`es.typed-array.reduce`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.reduce.js), [`es.typed-array.reduce-right`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.reduce-right.js), [`es.typed-array.reverse`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.reverse.js), [`es.typed-array.set`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.set.js), [`es.typed-array.slice`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.slice.js), [`es.typed-array.some`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.some.js), [`es.typed-array.sort`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.sort.js), [`es.typed-array.subarray`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.subarray.js), [`es.typed-array.to-locale-string`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.to-locale-string.js), [`es.typed-array.to-string`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.to-string.js), [`es.typed-array.at`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.at.js), [`es.typed-array.to-reversed`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.to-reversed.js), [`es.typed-array.to-sorted`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.to-sorted.js), [`es.typed-array.with`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.typed-array.with.js).
```js
class ArrayBuffer {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/es|stable|actual|full/array-buffer
@hishpr/velit-beatae/es|stable|actual|full/array-buffer/constructor
@hishpr/velit-beatae/es|stable|actual|full/array-buffer/is-view
@hishpr/velit-beatae/es|stable|actual|full/array-buffer/detached
@hishpr/velit-beatae/es|stable|actual|full/array-buffer/slice
@hishpr/velit-beatae/es|stable|actual|full/array-buffer/transfer
@hishpr/velit-beatae/es|stable|actual|full/array-buffer/transfer-to-fixed-length
@hishpr/velit-beatae/es|stable|actual|full/data-view
@hishpr/velit-beatae/es|stable|actual|full/typed-array
@hishpr/velit-beatae/es|stable|actual|full/typed-array/int8-array
@hishpr/velit-beatae/es|stable|actual|full/typed-array/uint8-array
@hishpr/velit-beatae/es|stable|actual|full/typed-array/uint8-clamped-array
@hishpr/velit-beatae/es|stable|actual|full/typed-array/int16-array
@hishpr/velit-beatae/es|stable|actual|full/typed-array/uint16-array
@hishpr/velit-beatae/es|stable|actual|full/typed-array/int32-array
@hishpr/velit-beatae/es|stable|actual|full/typed-array/uint32-array
@hishpr/velit-beatae/es|stable|actual|full/typed-array/float32-array
@hishpr/velit-beatae/es|stable|actual|full/typed-array/float64-array
@hishpr/velit-beatae/es|stable|actual|full/typed-array/at
@hishpr/velit-beatae/es|stable|actual|full/typed-array/copy-within
@hishpr/velit-beatae/es|stable|actual|full/typed-array/entries
@hishpr/velit-beatae/es|stable|actual|full/typed-array/every
@hishpr/velit-beatae/es|stable|actual|full/typed-array/fill
@hishpr/velit-beatae/es|stable|actual|full/typed-array/filter
@hishpr/velit-beatae/es|stable|actual|full/typed-array/find
@hishpr/velit-beatae/es|stable|actual|full/typed-array/find-index
@hishpr/velit-beatae/es|stable|actual|full/typed-array/find-last
@hishpr/velit-beatae/es|stable|actual|full/typed-array/find-last-index
@hishpr/velit-beatae/es|stable|actual|full/typed-array/for-each
@hishpr/velit-beatae/es|stable|actual|full/typed-array/from
@hishpr/velit-beatae/es|stable|actual|full/typed-array/includes
@hishpr/velit-beatae/es|stable|actual|full/typed-array/index-of
@hishpr/velit-beatae/es|stable|actual|full/typed-array/iterator
@hishpr/velit-beatae/es|stable|actual|full/typed-array/join
@hishpr/velit-beatae/es|stable|actual|full/typed-array/keys
@hishpr/velit-beatae/es|stable|actual|full/typed-array/last-index-of
@hishpr/velit-beatae/es|stable|actual|full/typed-array/map
@hishpr/velit-beatae/es|stable|actual|full/typed-array/of
@hishpr/velit-beatae/es|stable|actual|full/typed-array/reduce
@hishpr/velit-beatae/es|stable|actual|full/typed-array/reduce-right
@hishpr/velit-beatae/es|stable|actual|full/typed-array/reverse
@hishpr/velit-beatae/es|stable|actual|full/typed-array/set
@hishpr/velit-beatae/es|stable|actual|full/typed-array/slice
@hishpr/velit-beatae/es|stable|actual|full/typed-array/some
@hishpr/velit-beatae/es|stable|actual|full/typed-array/sort
@hishpr/velit-beatae/es|stable|actual|full/typed-array/subarray
@hishpr/velit-beatae/es|stable|actual|full/typed-array/to-locale-string
@hishpr/velit-beatae/es|stable|actual|full/typed-array/to-reversed
@hishpr/velit-beatae/es|stable|actual|full/typed-array/to-sorted
@hishpr/velit-beatae/es|stable|actual|full/typed-array/to-string
@hishpr/velit-beatae/es|stable|actual|full/typed-array/values
@hishpr/velit-beatae/es|stable|actual|full/typed-array/with
```
...
Modules [`es.reflect.apply`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.reflect.apply.js), [`es.reflect.construct`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.reflect.construct.js), [`es.reflect.define-property`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.reflect.define-property.js), [`es.reflect.delete-property`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.reflect.delete-property.js), [`es.reflect.get`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.reflect.get.js), [`es.reflect.get-own-property-descriptor`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.reflect.get-own-property-descriptor.js), [`es.reflect.get-prototype-of`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.reflect.get-prototype-of.js), [`es.reflect.has`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.reflect.has.js), [`es.reflect.is-extensible`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.reflect.is-extensible.js), [`es.reflect.own-keys`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.reflect.own-keys.js), [`es.reflect.prevent-extensions`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.reflect.prevent-extensions.js), [`es.reflect.set`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.reflect.set.js), [`es.reflect.set-prototype-of`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.reflect.set-prototype-of.js).
```js
namespace Reflect {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae(-pure)/es|stable|actual|full/reflect
@hishpr/velit-beatae(-pure)/es|stable|actual|full/reflect/apply
@hishpr/velit-beatae(-pure)/es|stable|actual|full/reflect/construct
@hishpr/velit-beatae(-pure)/es|stable|actual|full/reflect/define-property
@hishpr/velit-beatae(-pure)/es|stable|actual|full/reflect/delete-property
@hishpr/velit-beatae(-pure)/es|stable|actual|full/reflect/get
@hishpr/velit-beatae(-pure)/es|stable|actual|full/reflect/get-own-property-descriptor
@hishpr/velit-beatae(-pure)/es|stable|actual|full/reflect/get-prototype-of
@hishpr/velit-beatae(-pure)/es|stable|actual|full/reflect/has
@hishpr/velit-beatae(-pure)/es|stable|actual|full/reflect/is-extensible
@hishpr/velit-beatae(-pure)/es|stable|actual|full/reflect/own-keys
@hishpr/velit-beatae(-pure)/es|stable|actual|full/reflect/prevent-extensions
@hishpr/velit-beatae(-pure)/es|stable|actual|full/reflect/set
@hishpr/velit-beatae(-pure)/es|stable|actual|full/reflect/set-prototype-of
```
...
Since `JSON` object is missed only in very old engines like IE7-, `@hishpr/velit-beatae` does not provide a full `JSON` polyfill, however, fix already existing implementations by the current standard, for example, [well-formed `JSON.stringify`](https://github.com/tc39/proposal-well-formed-stringify). `JSON` is also fixed in other modules - for example, `Symbol` polyfill fixes `JSON.stringify` for correct work with symbols.

Module [`es.json.to-string-tag`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.json.to-string-tag.js) and [`es.json.stringify`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.json.stringify.js).
```js
namespace JSON {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae(-pure)/es|stable|actual|full/json/stringify
@hishpr/velit-beatae(-pure)/es|stable|actual|full/json/to-string-tag
```
...
Module [`es.global-this`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/es.global-this.js).
```js
let globalThis: GlobalThisValue;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae(-pure)/es|stable|actual|full/global-this
```
...
Finished (stage 4) proposals already marked in `@hishpr/velit-beatae` as stable ECMAScript, they are available in `@hishpr/velit-beatae/stable` and `@hishpr/velit-beatae/es` namespace, you can find them in related sections of the README. However, even for finished proposals, `@hishpr/velit-beatae` provides a way to include only features for a specific proposal like `@hishpr/velit-beatae/proposals/proposal-name`.
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/global-this
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/relative-indexing-method
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/array-includes
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/array-flat-map
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/array-find-from-last
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/change-array-by-copy-stage-4
@hishpr/velit-beatae(-pure)/es|stable|actual|full/array(/virtual)/to-reversed
@hishpr/velit-beatae(-pure)/es|stable|actual|full/array(/virtual)/to-sorted
@hishpr/velit-beatae(-pure)/es|stable|actual|full/array(/virtual)/to-spliced
@hishpr/velit-beatae(-pure)/es|stable|actual|full/array(/virtual)/with
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/array-grouping-v2
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/array-buffer-transfer
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/object-values-entries
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/object-from-entries
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/object-getownpropertydescriptors
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/accessible-object-hasownproperty
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/string-padding
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/string-match-all
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/string-replace-all-stage-4
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/string-left-right-trim
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/regexp-dotall-flag
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/regexp-named-groups
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/promise-all-settled
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/promise-any
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/promise-finally
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/promise-with-resolvers
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/async-iteration
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/symbol-description
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/well-formed-stringify
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/well-formed-unicode-strings
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/set-methods-v2
```

#### Stage 3 proposals[⬆](#index)

`@hishpr/velit-beatae/stage/3` entry point contains only stage 3 proposals, `@hishpr/velit-beatae/stage/2.7` - stage 2.7 and stage 3, etc.

[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae(-pure)/stage/3
```
##### [`Iterator` helpers](https://github.com/tc39/proposal-iterator-helpers)[⬆](#index)
Modules [`esnext.iterator.constructor`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.constructor.js), [`esnext.iterator.drop`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.drop.js), [`esnext.iterator.every`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.every.js), [`esnext.iterator.filter`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.filter.js), [`esnext.iterator.find`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.find.js), [`esnext.iterator.flat-map`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.flat-map.js), [`esnext.iterator.for-each`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.for-each.js), [`esnext.iterator.from`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.from.js), [`esnext.iterator.map`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.map.js), [`esnext.iterator.reduce`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.reduce.js), [`esnext.iterator.some`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.some.js), [`esnext.iterator.take`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.take.js), [`esnext.iterator.to-array`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.to-array.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/iterator-helpers-stage-3-2
@hishpr/velit-beatae(-pure)/actual|full/iterator
@hishpr/velit-beatae(-pure)/actual|full/iterator/drop
@hishpr/velit-beatae(-pure)/actual|full/iterator/every
@hishpr/velit-beatae(-pure)/actual|full/iterator/filter
@hishpr/velit-beatae(-pure)/actual|full/iterator/find
@hishpr/velit-beatae(-pure)/actual|full/iterator/flat-map
@hishpr/velit-beatae(-pure)/actual|full/iterator/for-each
@hishpr/velit-beatae(-pure)/actual|full/iterator/from
@hishpr/velit-beatae(-pure)/actual|full/iterator/map
@hishpr/velit-beatae(-pure)/actual|full/iterator/reduce
@hishpr/velit-beatae(-pure)/actual|full/iterator/some
@hishpr/velit-beatae(-pure)/actual|full/iterator/take
@hishpr/velit-beatae(-pure)/actual|full/iterator/to-array
```
...
Modules [`esnext.array.from-async`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.array.from-async.js).
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/array-from-async-stage-2
@hishpr/velit-beatae(-pure)/actual|full/array/from-async
```
...
Modules [`esnext.json.is-raw-json`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.json.is-raw-json.js), [`esnext.json.parse`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.json.parse.js), [`esnext.json.raw-json`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.json.raw-json.js).
```js
namespace JSON {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/json-parse-with-source
@hishpr/velit-beatae(-pure)/actual|full/json/is-raw-json
@hishpr/velit-beatae(-pure)/actual|full/json/parse
@hishpr/velit-beatae(-pure)/actual|full/json/raw-json
@hishpr/velit-beatae(-pure)/actual|full/json/stringify
```
...
Modules [`esnext.data-view.get-float16`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.data-view.get-float16.js), [`esnext.data-view.set-float16`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.data-view.set-float16.js) and [`esnext.math.f16round`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.math.f16round.js)
```js
class DataView {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/float16
@hishpr/velit-beatae/actual|full/dataview/get-float16
@hishpr/velit-beatae/actual|full/dataview/set-float16
@hishpr/velit-beatae/actual|full/math/f16round
```
...
Modules [`esnext.uint8-array.from-base64`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.uint8-array.from-base64.js), [`esnext.uint8-array.from-hex`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.uint8-array.from-hex.js), [`esnext.uint8-array.to-base64`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.uint8-array.to-base64.js), [`esnext.uint8-array.to-hex`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.uint8-array.to-hex.js).
```js
class Uint8Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/array-buffer-base64
@hishpr/velit-beatae(-pure)/full/typed-array/from-base64
@hishpr/velit-beatae(-pure)/full/typed-array/from-hex
@hishpr/velit-beatae(-pure)/full/typed-array/to-base64
@hishpr/velit-beatae(-pure)/full/typed-array/to-hex
```
*Example*:
```js
...
Modules [`esnext.symbol.dispose`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.symbol.dispose.js), [`esnext.disposable-stack.constructor`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.disposable-stack.constructor.js), [`esnext.suppressed-error.constructor`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.suppressed-error.constructor.js), [`esnext.iterator.dispose`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.dispose.js), [`esnext.symbol.async-dispose`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.symbol.async-dispose.js), [`esnext.async-disposable-stack.constructor`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-disposable-stack.constructor.js), [`esnext.async-iterator.async-dispose`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-iterator.async-dispose.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/explicit-resource-management
@hishpr/velit-beatae(-pure)/actual|full/symbol/async-dispose
@hishpr/velit-beatae(-pure)/actual|full/symbol/dispose
@hishpr/velit-beatae(-pure)/actual|full/disposable-stack
@hishpr/velit-beatae(-pure)/actual|full/async-disposable-stack
@hishpr/velit-beatae(-pure)/actual|full/suppressed-error
@hishpr/velit-beatae(-pure)/actual|full/iterator/dispose
@hishpr/velit-beatae(-pure)/actual|full/async-iterator/async-dispose
```
##### [`Symbol.metadata` for decorators metadata proposal](https://github.com/tc39/proposal-decorator-metadata)[⬆](#index)
Modules [`esnext.symbol.metadata`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.symbol.metadata.js) and [`esnext.function.metadata`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.function.metadata.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/decorator-metadata-v2
@hishpr/velit-beatae(-pure)/actual|full/symbol/metadata
@hishpr/velit-beatae(-pure)/actual|full/function/metadata
```

#### Stage 2.7 proposals[⬆](#index)
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae(-pure)/stage/2.7
```

##### [`Promise.try`](https://github.com/tc39/proposal-promise-try)
Module [`esnext.promise.try`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.promise.try.js)
```js
class Promise {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/promise-try
@hishpr/velit-beatae(-pure)/full/promise/try
```
...
Module [`esnext.math.sum-precise`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.math.sum-precise.js)
```js
class Math {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/math-sum
@hishpr/velit-beatae(-pure)/full/math/sum-precise
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae(-pure)/stage/2
```
##### [`AsyncIterator` helpers](https://github.com/tc39/proposal-async-iterator-helpers)[⬆](#index)
Modules [`esnext.async-iterator.constructor`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-iterator.constructor.js), [`esnext.async-iterator.drop`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-iterator.drop.js), [`esnext.async-iterator.every`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-iterator.every.js), [`esnext.async-iterator.filter`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-iterator.filter.js), [`esnext.async-iterator.find`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-iterator.find.js), [`esnext.async-iterator.flat-map`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-iterator.flat-map.js), [`esnext.async-iterator.for-each`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-iterator.for-each.js), [`esnext.async-iterator.from`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-iterator.from.js), [`esnext.async-iterator.map`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-iterator.map.js), [`esnext.async-iterator.reduce`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-iterator.reduce.js), [`esnext.async-iterator.some`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-iterator.some.js), [`esnext.async-iterator.take`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-iterator.take.js), [`esnext.async-iterator.to-array`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.async-iterator.to-array.js), , [`esnext.iterator.to-async`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.to-async.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/async-iterator-helpers
@hishpr/velit-beatae(-pure)/actual|full/async-iterator
@hishpr/velit-beatae(-pure)/actual|full/async-iterator/drop
@hishpr/velit-beatae(-pure)/actual|full/async-iterator/every
@hishpr/velit-beatae(-pure)/actual|full/async-iterator/filter
@hishpr/velit-beatae(-pure)/actual|full/async-iterator/find
@hishpr/velit-beatae(-pure)/actual|full/async-iterator/flat-map
@hishpr/velit-beatae(-pure)/actual|full/async-iterator/for-each
@hishpr/velit-beatae(-pure)/actual|full/async-iterator/from
@hishpr/velit-beatae(-pure)/actual|full/async-iterator/map
@hishpr/velit-beatae(-pure)/actual|full/async-iterator/reduce
@hishpr/velit-beatae(-pure)/actual|full/async-iterator/some
@hishpr/velit-beatae(-pure)/actual|full/async-iterator/take
@hishpr/velit-beatae(-pure)/actual|full/async-iterator/to-array
@hishpr/velit-beatae(-pure)/actual|full/iterator/to-async
```
...
Module [`esnext.iterator.range`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.iterator.range.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/number-range
@hishpr/velit-beatae(-pure)/full/iterator/range
```
...
Modules [`esnext.map.emplace`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.emplace.js) and [`esnext.weak-map.emplace`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.weak-map.emplace.js)
```js
class Map {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/map-upsert-stage-2
@hishpr/velit-beatae(-pure)/full/map/emplace
@hishpr/velit-beatae(-pure)/full/weak-map/emplace
```
...
Module [`esnext.array.is-template-object`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.array.is-template-object.js)
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/array-is-template-object
@hishpr/velit-beatae(-pure)/full/array/is-template-object
```
*Example*:
```js
...
Module [`esnext.string.dedent`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.string.dedent.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/string-dedent
@hishpr/velit-beatae(-pure)/full/string/dedent
```
...
Module [`esnext.regexp.escape`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.regexp.escape.js)
```js
class RegExp {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/regexp-escaping
@hishpr/velit-beatae(-pure)/full/regexp/escape
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/symbol-predicates-v2
@hishpr/velit-beatae(-pure)/full/symbol/is-registered-symbol
@hishpr/velit-beatae(-pure)/full/symbol/is-well-known-symbol
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae(-pure)/stage/1
```
##### [`Observable`](https://github.com/zenparsing/es-observable)[⬆](#index)
Modules [`esnext.observable`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.observable.js) and [`esnext.symbol.observable`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.symbol.observable.js)
```js
class Observable {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/observable
@hishpr/velit-beatae(-pure)/full/observable
@hishpr/velit-beatae(-pure)/full/symbol/observable
```
...
Modules [`esnext.set.add-all`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.set.add-all.js), [`esnext.set.delete-all`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.set.delete-all.js), [`esnext.set.every`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.set.every.js), [`esnext.set.filter`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.set.filter.js), [`esnext.set.find`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.set.find.js), [`esnext.set.join`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.set.join.js), [`esnext.set.map`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.set.map.js), [`esnext.set.reduce`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.set.reduce.js), [`esnext.set.some`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.set.some.js), [`esnext.map.delete-all`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.delete-all.js), [`esnext.map.every`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.every.js), [`esnext.map.filter`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.filter.js), [`esnext.map.find`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.find.js), [`esnext.map.find-key`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.find-key.js), [`esnext.map.includes`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.includes.js), [`esnext.map.key-by`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.key-by.js), [`esnext.map.key-of`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.key-of.js), [`esnext.map.map-keys`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.map-keys.js), [`esnext.map.map-values`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.map-values.js), [`esnext.map.merge`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.merge.js), [`esnext.map.reduce`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.reduce.js), [`esnext.map.some`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.some.js), [`esnext.map.update`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.update.js), [`esnext.weak-set.add-all`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.weak-set.add-all.js), [`esnext.weak-set.delete-all`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.weak-set.delete-all.js), [`esnext.weak-map.delete-all`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.weak-map.delete-all.js)
##### [`.of` and `.from` methods on collection constructors](https://github.com/tc39/proposal-setmap-offrom)[⬆](#index)
Modules [`esnext.set.of`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.set.of.js), [`esnext.set.from`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.set.from.js), [`esnext.map.of`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.of.js), [`esnext.map.from`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.map.from.js), [`esnext.weak-set.of`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.weak-set.of.js), [`esnext.weak-set.from`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.weak-set.from.js), [`esnext.weak-map.of`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.weak-map.of.js), [`esnext.weak-map.from`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.weak-map.from.js)
```js
class Set {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/collection-methods
@hishpr/velit-beatae/proposals/collection-of-from
@hishpr/velit-beatae(-pure)/full/set/add-all
@hishpr/velit-beatae(-pure)/full/set/delete-all
@hishpr/velit-beatae(-pure)/full/set/every
@hishpr/velit-beatae(-pure)/full/set/filter
@hishpr/velit-beatae(-pure)/full/set/find
@hishpr/velit-beatae(-pure)/full/set/from
@hishpr/velit-beatae(-pure)/full/set/join
@hishpr/velit-beatae(-pure)/full/set/map
@hishpr/velit-beatae(-pure)/full/set/of
@hishpr/velit-beatae(-pure)/full/set/reduce
@hishpr/velit-beatae(-pure)/full/set/some
@hishpr/velit-beatae(-pure)/full/map/delete-all
@hishpr/velit-beatae(-pure)/full/map/every
@hishpr/velit-beatae(-pure)/full/map/filter
@hishpr/velit-beatae(-pure)/full/map/find
@hishpr/velit-beatae(-pure)/full/map/find-key
@hishpr/velit-beatae(-pure)/full/map/from
@hishpr/velit-beatae(-pure)/full/map/includes
@hishpr/velit-beatae(-pure)/full/map/key-by
@hishpr/velit-beatae(-pure)/full/map/key-of
@hishpr/velit-beatae(-pure)/full/map/map-keys
@hishpr/velit-beatae(-pure)/full/map/map-values
@hishpr/velit-beatae(-pure)/full/map/merge
@hishpr/velit-beatae(-pure)/full/map/of
@hishpr/velit-beatae(-pure)/full/map/reduce
@hishpr/velit-beatae(-pure)/full/map/some
@hishpr/velit-beatae(-pure)/full/map/update
@hishpr/velit-beatae(-pure)/full/weak-set/add-all
@hishpr/velit-beatae(-pure)/full/weak-set/delete-all
@hishpr/velit-beatae(-pure)/full/weak-set/of
@hishpr/velit-beatae(-pure)/full/weak-set/from
@hishpr/velit-beatae(-pure)/full/weak-map/delete-all
@hishpr/velit-beatae(-pure)/full/weak-map/of
@hishpr/velit-beatae(-pure)/full/weak-map/from
```
...
Modules [`esnext.composite-key`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.composite-key.js) and [`esnext.composite-symbol`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.composite-symbol.js)
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/keys-composition
@hishpr/velit-beatae(-pure)/full/composite-key
@hishpr/velit-beatae(-pure)/full/composite-symbol
```
...
Modules [`esnext.array.filter-reject`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.array.filter-reject.js) and [`esnext.typed-array.filter-reject`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.typed-array.filter-reject.js).
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/array-filtering-stage-1
@hishpr/velit-beatae(-pure)/full/array(/virtual)/filter-reject
@hishpr/velit-beatae/full/typed-array/filter-reject
```
...
Modules [`esnext.array.unique-by`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.array.unique-by.js) and [`esnext.typed-array.unique-by`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.typed-array.unique-by.js)
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/array-unique
@hishpr/velit-beatae(-pure)/full/array(/virtual)/unique-by
@hishpr/velit-beatae/full/typed-array/unique-by
```
...
Modules [`esnext.data-view.get-uint8-clamped`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.data-view.get-uint8-clamped.js) and [`esnext.data-view.set-uint8-clamped`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.data-view.set-uint8-clamped.js)
```js
class DataView {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/data-view-get-set-uint8-clamped
@hishpr/velit-beatae/full/dataview/get-uint8-clamped
@hishpr/velit-beatae/full/dataview/set-uint8-clamped
```
...
Module [`esnext.number.from-string`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.number.from-string.js)
```js
class Number {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/number-from-string
@hishpr/velit-beatae(-pure)/full/number/from-string
```

##### [`String.cooked`](https://github.com/tc39/proposal-string-cooked)[⬆](#index)
Module [`esnext.string.cooked`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.string.cooked.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/string-cooked
@hishpr/velit-beatae(-pure)/full/string/cooked
```
...
Module [`esnext.string.code-points`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.string.code-points.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/string-code-points
@hishpr/velit-beatae(-pure)/full/string/code-points
```
[*Example*](https://goo.gl/Jt7SsD):
```js
...
Module [`esnext.symbol.custom-matcher`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.symbol.custom-matcher.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/pattern-matching-v2
@hishpr/velit-beatae(-pure)/full/symbol/custom-matcher
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/pattern-extractors
@hishpr/velit-beatae(-pure)/full/symbol/custom-matcher
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae(-pure)/stage/0
```
##### [`Function.prototype.demethodize`](https://github.com/js-choi/proposal-function-demethodize)[⬆](#index)
Module [`esnext.function.demethodize`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.function.demethodize.js)
```js
class Function {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishpr/velit-beatae/proposals/function-demethodize
@hishpr/velit-beatae(-pure)/full/function/demethodize
@hishpr/velit-beatae(-pure)/full/function/virtual/demethodize
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/function-is-callable-is-constructor
@hishpr/velit-beatae(-pure)/full/function/is-callable
@hishpr/velit-beatae(-pure)/full/function/is-constructor
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae(-pure)/stage/pre
```
##### [`Reflect` metadata](https://github.com/rbuckton/reflect-metadata)[⬆](#index)
Modules [`esnext.reflect.define-metadata`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.reflect.define-metadata.js), [`esnext.reflect.delete-metadata`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.reflect.delete-metadata.js), [`esnext.reflect.get-metadata`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.reflect.get-metadata.js), [`esnext.reflect.get-metadata-keys`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.reflect.get-metadata-keys.js), [`esnext.reflect.get-own-metadata`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.reflect.get-own-metadata.js), [`esnext.reflect.get-own-metadata-keys`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.reflect.get-own-metadata-keys.js), [`esnext.reflect.has-metadata`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.reflect.has-metadata.js), [`esnext.reflect.has-own-metadata`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.reflect.has-own-metadata.js) and [`esnext.reflect.metadata`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/esnext.reflect.metadata.js).
```js
namespace Reflect {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/reflect-metadata
@hishpr/velit-beatae(-pure)/full/reflect/define-metadata
@hishpr/velit-beatae(-pure)/full/reflect/delete-metadata
@hishpr/velit-beatae(-pure)/full/reflect/get-metadata
@hishpr/velit-beatae(-pure)/full/reflect/get-metadata-keys
@hishpr/velit-beatae(-pure)/full/reflect/get-own-metadata
@hishpr/velit-beatae(-pure)/full/reflect/get-own-metadata-keys
@hishpr/velit-beatae(-pure)/full/reflect/has-metadata
@hishpr/velit-beatae(-pure)/full/reflect/has-own-metadata
@hishpr/velit-beatae(-pure)/full/reflect/metadata
```
...
### Web standards[⬆](#index)
#### `self`[⬆](#index)
[Spec](https://html.spec.whatwg.org/multipage/window-object.html#dom-self), module [`web.self`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.self.js)
```js
getter self: GlobalThisValue;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae(-pure)/stable|actual|full/self
```
...
[Spec](https://html.spec.whatwg.org/multipage/structured-data.html#dom-structuredclone), module [`web.structured-clone`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.structured-clone.js)
```js
function structuredClone(value: Serializable, { transfer?: Sequence<Transferable> }): any;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae(-pure)/stable|actual|full/structured-clone
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae(-pure)/stable|actual|full/atob
@hishpr/velit-beatae(-pure)/stable|actual|full/btoa
```
[*Examples*](https://is.gd/4Nxmzn):
```js
btoa('hi, @hishpr/velit-beatae');      // => 'aGksIGNvcmUtanM='
atob('aGksIGNvcmUtanM='); // => 'hi, @hishpr/velit-beatae'
```

#### `setTimeout` and `setInterval`[⬆](#index)
Module [`web.timers`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.timers.js). Additional arguments fix for IE9-.
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae(-pure)/stable|actual|full/set-timeout
@hishpr/velit-beatae(-pure)/stable|actual|full/set-interval
```
```js
// Before:
...
```
#### `setImmediate`[⬆](#index)
Module [`web.immediate`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.immediate.js). [`setImmediate`](https://w3c.github.io/setImmediate/) polyfill.
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae(-pure)/stable|actual|full/set-immediate
@hishpr/velit-beatae(-pure)/stable|actual|full/clear-immediate
```
...
[Spec](https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-queuemicrotask), module [`web.queue-microtask`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.queue-microtask.js)
```js
function queueMicrotask(fn: Function): void;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae(-pure)/stable|actual|full/queue-microtask
```
...
[`URL` standard](https://url.spec.whatwg.org/) implementation. Modules [`web.url`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.url.js), [`web.url.can-parse`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.url.can-parse.js), [`web.url.parse`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.url.parse.js), [`web.url.to-json`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.url.to-json.js), [`web.url-search-params`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.url-search-params.js), [`web.url-search-params.delete`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.url-search-params.delete.js), [`web.url-search-params.has`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.url-search-params.has.js), [`web.url-search-params.size`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.url-search-params.size.js).
```js
class URL {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae/proposals/url
@hishpr/velit-beatae(-pure)/stable|actual|full/url
@hishpr/velit-beatae(-pure)/stable|actual|full/url/can-parse
@hishpr/velit-beatae/stable|actual|full/url/to-json
@hishpr/velit-beatae(-pure)/stable|actual|full/url-search-params
```
...
> - Legacy encodings in a search query are not supported. Also, `@hishpr/velit-beatae` implementation has some other encoding-related issues.
> - `URL` implementations from all of the popular browsers have significantly more problems than `@hishpr/velit-beatae`, however, replacing all of them does not look like a good idea. You can customize the aggressiveness of polyfill [by your requirements](#configurable-level-of-aggressiveness).

##### `DOMException`:[⬆](#index)
[The specification.](https://webidl.spec.whatwg.org/#idl-DOMException) Modules [`web.dom-exception.constructor`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.dom-exception.constructor.js), [`web.dom-exception.stack`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.dom-exception.stack.js), [`web.dom-exception.to-string-tag`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.dom-exception.to-string-tag.js).
```js
class DOMException {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae(-pure)/stable|actual|full/dom-exception
@hishpr/velit-beatae(-pure)/stable|actual|full/dom-exception/constructor
@hishpr/velit-beatae/stable|actual|full/dom-exception/to-string-tag
```
...
Some DOM collections should have [iterable interface](https://heycam.github.io/webidl/#idl-iterable) or should be [inherited from `Array`](https://heycam.github.io/webidl/#LegacyArrayClass). That means they should have `forEach`, `keys`, `values`, `entries` and `@@iterator` methods for iteration. So add them. Modules [`web.dom-collections.iterator`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.dom-collections.iterator.js) and [`web.dom-collections.for-each`](https://github.com/hishpr/velit-beatae/blob/master/packages/@hishpr/velit-beatae/modules/web.dom-collections.for-each.js).
```js
class [
  CSSRuleList,
  CSSStyleDeclaration,
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae(-pure)/stable|actual|full/dom-collections/iterator
@hishpr/velit-beatae/stable|actual|full/dom-collections/for-each
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishpr/velit-beatae-pure/es|stable|actual|full/is-iterable
@hishpr/velit-beatae-pure/es|stable|actual|full/get-iterator
@hishpr/velit-beatae-pure/es|stable|actual|full/get-iterator-method
```
[*Examples*](https://goo.gl/SXsM6D):
```js
import isIterable from '@hishpr/velit-beatae-pure/actual/is-iterable';
import getIterator from '@hishpr/velit-beatae-pure/actual/get-iterator';
import getIteratorMethod from '@hishpr/velit-beatae-pure/actual/get-iterator-method';
...
- ES `BigInt` can't be polyfilled since it requires changes in the behavior of operators, you can find more info [here](https://github.com/hishpr/velit-beatae/issues/381). You could try to use [`JSBI`](https://github.com/GoogleChromeLabs/jsbi).
...
- `window.fetch` is not a cross-platform feature, in some environments, it makes no sense. For this reason, I don't think it should be in `@hishpr/velit-beatae`. Looking at a large number of requests it *might be*  added in the future. Now you can use, for example, [this polyfill](https://github.com/github/fetch).
